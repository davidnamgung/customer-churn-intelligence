...
---
<style>
  /* Your existing bolding style */
  strong, b {
    font-weight: 900 !important;
    -webkit-text-stroke: 0.4px #2C3E50;
  }

  /* Custom styling for your tags */
  .badge {
    font-size: 0.85rem;
    padding: 8px 12px;
    margin: 4px;
...
<div style="text-align: center; margin-bottom: 25px;">
  <a href="www.linkedin.com/in/david-namgung" target="_blank" style="text-decoration: none; margin: 0 15px;">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn">
  </a>
  <a href="https://davidnamgung.github.io/portfolio-website/" target="_blank" style="text-decoration: none; margin: 0 15px;">
    <img src="https://img.shields.io/badge/Portfolio-2C3E50?style=for-the-badge&logo=react&logoColor=white" alt="Portfolio">
  </a>
  <a href="https://github.com/davidnamgung" target="_blank" style="text-decoration: none; margin: 0 15px;">
    <img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub">
  </a>

  <span class="badge bg-primary">R / Tidyverse</span>
  <span class="badge bg-primary">PostgreSQL</span>
  <span class="badge bg-primary">Data Analysis (EDA)</span>
  <span class="badge bg-primary">Hypothesis Testing</span>
  <span class="badge bg-primary">GBM</span>
  <span class="badge bg-primary">Logistic Regression</span>
  <span class="badge bg-primary">RandomForest</span>
  <span class="badge bg-primary">API Integration</span>
  <span class="badge bg-primary">ROI Optimized</span>
</div>
...
[⬇️ Download Raw IBM Telco Dataset (CSV)](data/telco_raw.csv){.btn .btn-primary .btn-sm .rounded-pill download="IBM_Telco_Churn_Raw.csv"}
...
<div style="text-align: center; margin: 20px 0;">
  [📊 View Interactive Tableau Dashboard (Needs work)](https://public.tableau.com/views/CustomerChurnIntelligence/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link){.btn .btn-info .btn-sm .rounded-pill target="_blank"}
</div>
...
Sensitivity (TPR): The ratio of correctly predicted positive observations to all observations in the actual class.
